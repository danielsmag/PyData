...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "my-bucket",
            "with-key",
            S3Path(url="s3://my-bucket/"),
            "s3",
            False,
        ),
        ("s3a://my-bucket/", "my-bucket", "", None, "s3a", True),
        (
            "s3a://my.bucket.name/my-key",
            "my.bucket.name",
            "my-key",
            S3Path(url="s3a://my.bucket.name/"),
            "s3a",
            False,
        ),
        (
        ...
        (
            "s3a://my-bucket/with-key",
            "my-bucket",
            "with-key",
            S3Path(url="s3a://my-bucket/"),
            "s3a",
            False,
        ),
    ],
...
def test_invalid_s3_paths(url: str) -> None:
