...
class ApplicationContainer(containers.DeclarativeContainer):
    ...
    spark = providers.Container(container_cls=SparkContainer, core=core, config=config)

    general = providers.Container(
        container_cls=GeneralContainer, config=config, core=core
    )

    cache = providers.Container(container_cls=CacheContainer, config=config)

    data_catalog = providers.Container(
        container_cls=DataCatalogContainer, config=config, core=core
    )
